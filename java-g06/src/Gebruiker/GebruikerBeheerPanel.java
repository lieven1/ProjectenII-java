...
public class GebruikerBeheerPanel extends Pane implements Panel {
    public GebruikerBeheerPanel(ApplicatieFrameController frame){
        Label lblTitle = new Label("GebruikerbeheerPanel");
