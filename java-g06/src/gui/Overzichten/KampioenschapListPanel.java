 ...
 * @author boris
 */
public class KampioenschapListPanel  extends OverzichtListPanel {

    private OverzichtController oc;

    KampioenschapListPanel(OverzichtController oc) {
        this.oc = oc;
        ...
        Label lblGebruikersTitle = new Label("Hier komt een lijst van de Kampioenschappen");
    ...
    public AnchorPane createFilterPane() {
        ...
        Label lblFilterTitle = new Label("Hier komt een filter voor kampioenschappen");
