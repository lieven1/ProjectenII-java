...
public class GebruikerTest {
    ...
    public void maakGebruiker_ValidGegevens_MaaktGebruiker() {        
        g1 = new Gebruiker(Gebruikersnaam, Rijksregisternummer, Inschrijvingsdatum, Naam, Voornaam, Geslacht, Geboortedatum, Geboorteplaats, Telefoonnummer, Gsmnummer, Email, Emailouders, Adres.getLand(), Adres.getPostcode(), Adres.getStad(), Adres.getStraat(), Adres.getNummer(), Gradatie, TypeGebruiker, Lesformule);
